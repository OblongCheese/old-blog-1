...
L.Instagram = L.FeatureGroup.extend({
        options: {
            ...
            onClick: function(a) {
                var b = a.layer.image,
                    c = this.options,
                    d = c.imageTemplate;
                "video" === b.type && document.createElement("video").canPlayType("video/mp4; codecs=avc1.42E01E,mp4a.40.2") && (d = c.videoTemplate),
    ...
    L.Instagram.Fancybox = L.Instagram.extend({
        options: {
            ...
            onClick: function(a) {
                var b = a.layer.image;
                "video" === b.type && document.createElement("video").canPlayType("video/mp4; codecs=avc1.42E01E,mp4a.40.2") ? $.fancybox({
                    type: "inline",
                    content: '<video autoplay controls poster="' + b.image_standard + '"><source src="' + b.video_standard + '" type="video/mp4"/></video>',
                    title: b.caption
                }, this.options.fancybox) : $.fancybox({
                    href: b.image_standard,
                    title: b.caption
                }, this.options.fancybox)
            }
        }
    }),
    L.instagram.fancybox = function(a, b) {
        return new L.Instagram.Fancybox(a, b)
    };
