...
! function() {
    ...
    function a(a) {
        var b = parseFloat(a.fontSize),
            c = "normal" === a.lineHeight ? p * b : parseFloat(a.lineHeight);
        return {
            leading: c - b,
            lineHeight: c,
            fontSize: b
    ...
    function b(a) {
        ...
        return b.style.position = "fixed", b.style.padding = o, b.style.opacity = "0", b.style.fontSize = n, b.style.lineHeight = "1", a.body.appendChild(b), b
    }

    function c(a) {
        var b = a.ownerDocument.createElement("span");
        return b.textContent = l, a && a.appendChild(b), b
    }
    ...
    function e(a, b, c, d) {
        ...
        h.font = n + " " + b, h.fillStyle = "#ffffff", h.fillRect(0, 0, h.canvas.width, h.canvas.height), h.fillStyle = "#000000", h.textBaseline = "top", h.fillText("E", 0, 0);
    ...
    function f(a, f) {
        ...
        if (g) return g;
        g = {
            baselineRatio: void 0,
            capHeightRatio: void 0
        };
        var h = b(a);
        ...
        i.style.fontSize = o;
        var j = c(h);
        g.baselineRatio = i.offsetTop / m;
        try {
            g.capHeightRatio = e(h, f, j.offsetWidth, m)
        } catch (k) {
            throw new Error("[dropcap.js] Error computing font metrics: " + k.message)
        } finally {
            d(h)
        }
        return q[f] = g, g
    ...
    function h(a) {
        return a.classList.contains(r) ? !0 : void 0
    }
    ...
    function j(a) {
        a.dcapjs && (a.style.cssFloat = "", a.style.padding = "", a.style.fontSize = "", a.style.lineHeight = "", a.style.marginTop = "")
    }
    ...
    function k(b, c, d) {
        ...
        var e = b.ownerDocument,
            ...
            r = p.capHeightRatio,
            s = a(n),
            t = (q.baselineRatio - q.capHeightRatio) * s.fontSize,
            u = c * s.lineHeight - s.leading - t - (1 - q.baselineRatio) * s.fontSize,
            v = u / r;
        k.dcapjs = !0, k.style.cssFloat = "left", k.style.padding = o, k.style.fontSize = g(v), k.style.lineHeight = o;
        var w = s.leading / 2 + t;
        ...
        var y = 0;
        i(k) ? y = v * (1 - p.baselineRatio) : h(k) && (y = v - u), k.style.height = g(u + y);
        var z = k.dcapjsStrut;
